...
public class FileManager {
    ...
    public void uploadImage(File file) {
            try {
                ImageIO.write(ic.processImage(),"PNG", file);
                JOptionPane.showMessageDialog(null, new JLabel("File was saved", JLabel.CENTER));
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public void doRecognize() {
           ic = new ImageProcessing(images[0], images[1]);
    }
